caseInterpolationHeadline = Fluent: Case interpolation

caseInterpolationPreamble = Also known as selectors in the Fluent handbook, we chose this name because it mimics (and compiles to)
  Elms <code>case .. of</code> statement. 

caseInterpolationSyntaxHeadline = Syntax
caseInterpolationSyntaxBody = All you need to do to get started is take a normal interpolation statement, insert a line-break after
...
caseInterpolationAdviceHeadline = Advice
caseInterpolationAdviceBody = Do not rely on this feature too much. Matching against a custom data type in Elm code is often
