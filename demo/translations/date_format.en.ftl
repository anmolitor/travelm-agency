headline = Fluent: Formatting dates
...
preamble = Dates can be presented in even more different ways than numbers can.
...
intlBody = Luckily the browsers <a href="{-intl-link}">Intl API</a> helps us out once again. 
...
compileTimeHeadline = Compile time execution
compileTimeBody = You may pass a string literal instead of a variable into the DATETIME function,
