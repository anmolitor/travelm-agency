htmlHeadline = Html
htmlPreamble = Previously, the return type for all the generated translation key functions was <code>String</code>. 
...
htmlBasicsHeadline = Basics
htmlBasicsBody = To make Travelm-Agency generate HTML, all you need to do is wrap an HTML tag around a part of your translation.
...
htmlIdHeadline = Identification
htmlIdBody = If you want to style a single html tag specifically, or multiple different html tags with the same attributes,
  you can use the special "_id" attribute on the respective tags.

htmlSecurityHeadline = Security
htmlSecurityBody = There is a good reason why Elm does not generate HTML from a String at runtime - cross-site scripting
