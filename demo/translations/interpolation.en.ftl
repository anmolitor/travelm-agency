...
jsonSyntaxBody = JSON does not specify a placeholder syntax. We chose the familiar curly bracket syntax:
  If you want to insert a runtime value in \"Hello, !\" for the person you want to greet, you could write 
  \"Hello, { "{person}!" }\" for example. If you want an actual opening curly bracket, use backslash to escape it.
...
propertiesSyntaxBody = Properties does not specify a placeholder syntax either. Just like with JSON, we chose curly bracket syntax:
  If you want to insert a runtime value in \"Hello, !\" for the person you want to greet, you could write 
  \"Hello, { "{person}!" }" for example. If you want an actual opening curly bracket, use quotation marks to escape it.
...
fluentSyntaxBody = Fluent uses curly bracket syntax with a twist for its interpolation syntax.
  ...
  If you want to insert a runtime value in \"Hello, !\" for the person you want to greet, you could write 
  \"Hello, { "{$person}!" }\" for example. If you want an actual opening curly bracket, use string literals ({ "{ \"...\" }" }) to escape it.
