numberFormatHeadline = Fluent: Formatting numbers
...
numberFormatPreamble = Did you know that different languages format numbers in different ways?
...
numberFormatIntlHeadline = Elm and the Intl APIs
numberFormatIntlBody = Formatting numbers in a variety of different ways is a lot of work.
...
numberFormatOptionsHeadline = Additional options
numberFormatOptionsBody = The NumberFormat.format method can take a variety of different options which are documented
