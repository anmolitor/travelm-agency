headline = Fluent: Plural Rules

preamble = Some languages differ in their grammatic or wording based on
...
intlBody = Just a heads-up - you will need to include the intl-proxy package for this feature as well.
