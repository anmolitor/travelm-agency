...
[language,json]
----
["{1} {P0|\"one\":\"added a new photo\",\"*\":\"added {0} new photos\"}"]
----
...
* The arguments are given in JSON style
* If the Intl API responds with "one", we use the value of the key "one", in any other case we default to the value of the key "*"
