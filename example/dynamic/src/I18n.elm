...
{-| This file was generated by elm-i18n version 2.1.0.
...
will make a `GET` request to /i18n/messages.de.1785931441.json and will call GotTranslations with the decoded response.
...
languageToFileName_messages lang_ =
    case lang_ of
        De ->
            "messages.de.1785931441.json"

        En ->
            "messages.en.3934005096.json"
