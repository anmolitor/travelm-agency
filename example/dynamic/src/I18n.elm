module I18n exposing (I18n, Language(..), decodeDemo, decodeMessages, demoKey, escapedChars, formattedDate, greeting, init, languageFromString, languageSwitchInfo, languageToFileName_demo, languageToFileName_messages, languageToString, languages, loadDemo, loadMessages, order, static)
...
formattedDate : I18n -> String -> String
formattedDate (I18n { messages }) date_ =
...
will make a `GET` request to /i18n/demo.de.3281739644.json and will call GotTranslations with the decoded response.
...
languageToFileName_demo lang_ =
    case lang_ of
        De ->
            "demo.de.3281739644.json"

        En ->
            "demo.en.1560487837.json"

        Fr ->
            "demo.fr.3281739644.json"
...
will make a `GET` request to /i18n/messages.de.1561633265.json and will call GotTranslations with the decoded response.
...
languageToFileName_messages lang_ =
    case lang_ of
        De ->
            "messages.de.1561633265.json"

        En ->
            "messages.en.1186453793.json"

        Fr ->
            "messages.fr.2919239911.json"
