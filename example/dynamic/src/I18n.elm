module I18n exposing (I18n, Language(..), decodeDemo, decodeMessages, demoKey, greeting, init, languageFromString, languageSwitchInfo, languageToFileName_demo, languageToFileName_messages, languageToString, languages, loadDemo, loadMessages, order, static)
...
will make a `GET` request to /i18n/messages.de.1799595215.json and will call GotTranslations with the decoded response.
...
languageToFileName_messages lang_ =
    case lang_ of
        De ->
            "messages.de.1799595215.json"

        En ->
            "messages.en.1156448062.json"

        Fr ->
            "messages.fr.922775346.json"
