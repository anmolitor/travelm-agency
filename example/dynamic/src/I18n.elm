module I18n exposing (I18n, Language(..), decodeDemo, decodeMessages, demoKey, escapedChars, greeting, init, languageFromString, languageSwitchInfo, languageToFileName_demo, languageToFileName_messages, languageToString, languages, loadDemo, loadMessages, order, static)

{-| This file was generated by elm-i18n version 2.3.0.
