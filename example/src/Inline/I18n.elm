module Inline.I18n exposing (I18n, Language(..), differentVars, greeting, htmlTest, init, languageFromString, languageSwitchInfo, languageToString, languages, load, orderDemo, specialCharacters, staticText)
...
type alias I18n =
    ...
    , htmlTest_ : String -> { spanId : List (Html.Attribute Never) } -> List (Html.Html Never)
...
htmlTest : I18n -> String -> { spanId : List (Html.Attribute Never) } -> List (Html.Html Never)
htmlTest i18n =
    i18n.htmlTest_
...
de =
    ...
    , htmlTest_ = \spanIdAttrs with -> [ Html.text "" ]
    , languageSwitchInfo_ =
...
en =
    ...
    , htmlTest_ =
        \spanIdAttrs with ->
            [ Html.text "just some "
            , Html.node "span" [] [ Html.text "html ", Html.text with, Html.text " interpolation" ]
            ]
    , languageSwitchInfo_ =
...
fr =
    ...
    , htmlTest_ = \spanIdAttrs with -> [ Html.text "some" ]
    , languageSwitchInfo_ =
