...
emptyFile ctx =
    let
        fileComment =
            CG.emptyFileComment
                |> CG.markdown
                    ("This file was generated by travelm-agency version "
                        ++ ctx.version
                        ++ "."
                    )
                |> CG.markdown "If you have any issues with the generated code, do not hesitate to open an issue here: https://github.com/andreasewering/travelm-agency/issues"
    in
