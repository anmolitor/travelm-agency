module Types.UniqueName exposing (UniqueNameContext, andThen, andThen2, andThen3, andThen4, combineAndThen, map, new, scoped, unwrap)
...
andThen : String -> (UniqueNameContext () -> a -> String -> b) -> UniqueNameContext a -> UniqueNameContext b
...
threadCtx : UniqueNameContext a -> (UniqueNameContext () -> a -> b) -> b
threadCtx (Context s a) f =
    f (Context s ()) a


andThen2 : String -> String -> (UniqueNameContext () -> a -> String -> String -> b) -> UniqueNameContext a -> UniqueNameContext b
andThen2 n1 n2 doWithName ctx =
    andThen n1 doWithName ctx |> andThen n2 (always (<|))


andThen3 : String -> String -> String -> (UniqueNameContext () -> a -> String -> String -> String -> b) -> UniqueNameContext a -> UniqueNameContext b
andThen3 n1 n2 n3 doWithName ctx =
    andThen2 n1 n2 doWithName ctx |> andThen n3 (always (<|))


andThen4 : String -> String -> String -> String -> (UniqueNameContext () -> a -> String -> String -> String -> String -> b) -> UniqueNameContext a -> UniqueNameContext b
...
-}
combineAndThen : (a -> Set String) -> (UniqueNameContext () -> a -> (String -> String) -> b) -> UniqueNameContext a -> UniqueNameContext b
    ...
    let
        ...
        lookup name =
            Dict.get name lookupDict
                |> Maybe.withDefault "!!! This should not happen! Open an issue at https://github.com/andreasewering/travelm-agency/issues please, so this will not happen again."
    in
