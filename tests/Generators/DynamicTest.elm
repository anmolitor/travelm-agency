...
languageToFileName_messages lang_ =
    case lang_ of
        En ->
            "messages.1234.json"
"""
        , test "two languages with inconsistent placeholders" <|
            \_ ->
                Dict.NonEmpty.fromList
                    ...
                    |> Dynamic.toFile context
                    |> Elm.Pretty.pretty 120
                    |> Expect.equal """module Test exposing (I18n, Language(..), decodeMessages, init, key, languageFromString, languageToFileName_messages, languageToString, languages, loadMessages)
...
key (I18n { messages }) placeholders_ =
    case Array.get 0 messages of
        Just translation_ ->
            replacePlaceholders [ placeholders_.bla, placeholders_.blub, placeholders_.wow ] translation_
...
will make a `GET` request to /i18n/messages.1234.de.json and will call GotTranslations with the decoded response.
...
languageToFileName_messages lang_ =
    case lang_ of
        De ->
            "messages.1234.de.json"

        En ->
            "messages.4321.en.json"
"""
        ]
